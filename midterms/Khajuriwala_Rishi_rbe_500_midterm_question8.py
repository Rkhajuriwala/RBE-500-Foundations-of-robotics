...
with open('Midterm_F17_LIDAR_Ultrasound_100ms_1m_000.csv','rb') as csvfile:
...
with open('Midterm_F17_LIDAR_Ultrasound_100ms_2m_000.csv','rb') as csvfile:
...
print 'Answer 8a Bias for lidar sensor at 1 m range:',bias_1_m_lidar
print 'Answer 8a Bias for lidar sensor at 2 m range:',bias_2_m_lidar
print 'Answer 8a Standard deviation for lidar sensor at 1m range:',lidar_1_m_stddev
print 'Answer 8a Standard deviation for lidar sensor at 2m range:',lidar_2_m_stddev

print 'Answer 8b Bias for ultrasound sensor at 1 m range:',bias_1_m_ultra
print 'Answer 8b Bias for ultrasound sensor at 2 m range:',bias_2_m_ultra
print 'Answer 8b Standard deviation for ultrasound sensor at 1m range:',ultra_1_m_stddev
print 'Answer 8b Standard deviation for ultrasound sensor at 2m range:',ultra_2_m_stddev

#print 'Answer 8c Adjusted array by combing readings of lidar and ultrasound sensors at 1m range:',Adjust_1_m
print 'Answer 8c mean for combined readings for 1 m range:',np.mean(Adjust_1_m)
print 'Answer 8c Standard deviation for combined for 1 m range:',np.std(Adjust_1_m,ddof=1)
#print 'Answer 8c Adjusted array by combing readings of lidar and ultrasound sensors at 2m range:',Adjust_2_m
print 'Answer 8c mean for combined readings for 2 m range:',np.mean(Adjust_2_m)
print 'Answer 8c Standard deviation for combined readings for 2 m range:',np.std(Adjust_2_m,ddof=1)